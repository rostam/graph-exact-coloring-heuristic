...
- **IndSet-based exact coloring** — computes the exact chromatic number via inclusion-exclusion over all independent sets (`indset_exact_coloring/indset_exact_coloring.h`)
- **IndSet-removal coloring** — a fast upper-bound heuristic that repeatedly peels off independent sets (`demo_indset_removal_coloring.cpp`)

## Algorithms

### IndSet-Based Exact Coloring
...
|----------------------------|------------------------------------|---------------------------------------------------------|
| `indset_exact_coloring`    | `demo_indset_exact_coloring.cpp`   | IndSet-based exact chromatic number for all graph families |
| `indset_removal_coloring`  | `demo_indset_removal_coloring.cpp` | IndSet-removal coloring demo                            |
| `tests`                    | `tests.cpp`                        | Runs the test suite and prints pass/fail counts         |

## Usage

```bash
# IndSet-based exact chromatic numbers for all graph families
./indset_exact_coloring

# IndSet-removal coloring demo
./indset_removal_coloring

# Run the test suite
./tests
```

Expected output from `./indset_exact_coloring` (excerpt):

```
=== IndSet-Based Exact Coloring: chromatic numbers ===
...
| Graph | Description | V | E | Known χ | IndSet-Exact | IndSet-Removal |
|---|---|:-:|:-:|:-:|:-:|:-:|
| C₃ | Triangle | 3 | 3 | 3 | 3 | 3 |
| C₄ | Square | 4 | 4 | 2 | 2 | 4 |
| C₅ | Pentagon | 5 | 5 | 3 | 3 | 3 |
| C₆ | Hexagon | 6 | 6 | 2 | 2 | 4 |
| C₇ | 7-cycle | 7 | 7 | 3 | 3 | 3 |
| K₁ – K₄ | Complete graphs | 1–4 | 0–6 | 1–4 | 1–4 | 1–4 |
| **K₉, K₁₀** | **Complete graphs** | **9,10** | **36,45** | **9,10** | **9,10** | **9,10** |
| E₁, E₃ | Edgeless | 1,3 | 0 | 1 | 1 | 1 |
| K₂,₃ | Complete bipartite | 5 | 6 | 2 | 2 | 3 |
| **W₅,W₇,W₉** | **Wheel (even rim) → χ=3** | 5,7,9 | 8,12,16 | **3** | **3** | **5** |
| **W₆,W₈** | **Wheel (odd rim) → χ=4** | 6,8 | 10,14 | **4** | **4** | **4** |
| **K₂,₂,₂** | **Octahedron** | **6** | **12** | **3** | **3** | **3** |
| **K₃,₃,₃** | **Complete 3-partite** | **9** | **27** | **3** | **3** | **4** |
| **K₂,₂,₂,₂** | **Complete 4-partite** | **8** | **24** | **4** | **4** | **4** |
| GP(4,1) | 3-cube Q₃ (bipartite) | 8 | 12 | 2 | 2 | 4 |
| GP(5,1) | Pentagonal prism | 10 | 15 | 3 | 3 | 3 |
| GP(5,2) | Petersen graph | 10 | 15 | 3 | 3 | 4 |
| GP(6,1) | Hexagonal prism (bipartite) | 12 | 18 | 2 | 2 | 4 |
| GP(6,2) | — | 12 | 18 | 3 | 3 | 4 |
| GP(7,2) | — | 14 | 21 | 3 | 3 | 4 |
| **K_{2×5} – K_{2×9}** | **Complete k-partite (2 per part)** | **10–18** | **40–144** | **5–9** | **5–9** | **9–17** |
...
| Matrix | Group | Domain | Processing | V | E | Known χ | IndSet-Exact | IndSet-Removal | Time |
|---|---|---|---|:-:|:-:|:-:|:-:|:-:|--:|
| `cage3` | vanHeukelum | DNA electrophoresis | full (symmetrized) | 5 | 7 | 3 | 3 | 3 | <1 ms |
| `cage4` | vanHeukelum | DNA electrophoresis | full (symmetrized) | 9 | 20 | 3 | 3 | 4 | 3 ms |
| `GD98_a` | Pajek | Graph Drawing contest 1998 | BFS-10 subgraph | 10 | 10 | 3 | 3 | 3 | 81 ms |
| `ndtest` | (project) | FEM/structural | BFS-10 subgraph | 10 | 14 | 2 | 2 | 3 | 15 ms |
...
| Graph | V | E | Known χ | IndSet-Exact | IndSet-Removal | Time |
|---|:-:|:-:|:-:|:-:|:-:|--:|
| C₈ | 8 | 8 | 2 | 2 | 4 | 1 ms |
| C₉ | 9 | 9 | 3 | 3 | 3 | 7 ms |
| C₁₀ | 10 | 10 | 2 | 2 | 4 | 24 ms |
| C₁₁ | 11 | 11 | 3 | 3 | 3 | 86 ms |
| C₁₂ | 12 | 12 | 2 | 2 | 4 | 168 ms |
| C₁₃ | 13 | 13 | 3 | 3 | 3 | 786 ms |
| C₁₄ | 14 | 14 | 2 | 2 | 4 | ~3 s |
| C₁₆ | 16 | 16 | 2 | 2 | 4 | ~33 s |
| K₅ – K₈ | 5–8 | 10–28 | 5–8 | 5–8 | 5–8 | < 1 ms |
| K₄,₄ | 8 | 16 | 2 | 2 | 5 | 1 ms |
| K₅,₅ | 10 | 25 | 2 | 2 | 6 | 9 ms |
| K₆,₆ | 12 | 36 | 2 | 2 | 7 | 69 ms |
| K₇,₇ | 14 | 49 | 2 | 2 | 8 | 536 ms |
| GP(6,2) | 12 | 18 | 3 | 3 | 4 | 135 ms |
| GP(7,2) | 14 | 21 | 3 | 3 | 4 | 1.3 s |
| GP(8,3) | 16 | 24 | 2 | 2 | 5 | ~15 s |
...
|---|:-:|:-:|:-:|:-:|:-:|--:|
| K₉ | 9 | 36 | 9 | 9 | 9 | 3 ms |
| K₁₀ | 10 | 45 | 10 | 10 | 10 | 9 ms |
| K_{2×5} | 10 | 40 | 5 | 5 | 9 | 7 ms |
| K_{2×6} | 12 | 60 | 6 | 6 | 11 | 47 ms |
| K_{2×7} | 14 | 84 | 7 | 7 | 13 | 287 ms |
| K_{2×8} | 16 | 112 | 8 | 8 | 15 | 1.1 s |
| K_{2×9} | 18 | 144 | 9 | 9 | 17 | 5.5 s |
...
├── indset_exact_coloring/
│   └── indset_exact_coloring.h    # IndSet-based exact coloring (chromatic polynomial via inclusion-exclusion)
├── generators/
...
├── demo_indset_exact_coloring.cpp  # IndSet-based exact coloring demo (all graph families)
├── demo_indset_removal_coloring.cpp # IndSet-removal coloring demo
...
### Key functions (`indset_exact_coloring/indset_exact_coloring.h`)
...
*IndSet-removal coloring of the original graph*
